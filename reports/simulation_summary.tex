...
Spatial filtering (\cite{Tiefelsdorf_Griffith_2007}) is a method [briefly describe what it does]. The next step is [explain the relationship between MC values and the eigenvalues built with MCM].
